...
| 제출 버튼        | 1    | - 설문지 좌측 하단에 제출 버튼 존재<br/>- 제출 버튼 클릭시, 설문지 제출 완료 페이지가 렌더링됨<br/>- 필수 질문 미작성 시, 제출 완료 페이지로 이동되지 않음<br/>- 미작성된 필수 질문 박스들의 테두리가 빨간색으로 변경되고 박스 내 아래 부분에 '필수 질문입니다.' 텍스트가 뜸                                                                                                                                                                                                                                                                                                | △    |
